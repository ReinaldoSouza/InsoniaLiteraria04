...
namespace InsoniaLiteraria04.CardView
{
    ...
    public partial class SegredosInternosCardView : Frame
    {
        DBFireViews dbViews;
        DBFireComentarios dbComentario;
        public SegredosInternosCardView()
        {
            InitializeComponent();
        ...
        public async void quantidadeMensagens()
        {
            ...
            try
            {
                var listAsync = await dbComentario.mostrarQuantidadeComentariosTotal("SegInternos");
        ...
        public async void quantidadeView()
        {
            ...
            try
            {
                ...
                var listAsyncV = await dbViews.mostrarQuantidadeViewTotal("SegInternos");
