	...
	public partial class MenuEstranhaPage : ContentPage
	{
        ...
        public async void carregarViews()
        {
            try
            {
                ...
                var listAsyncMenu = await serviceMenus.mostrarMenu("Estranha");
                var listMenu = listAsyncMenu.ToList();

                var listAsyncViews = await serviceViews.mostrarQuantidadeCapitulo("Estranha");
                ...
                var listAsyncComents = await serviceComentarios.mostrarComentarioCapitulo("Estranha");
